...
import com.gigaspaces.demo.kstreams.processors.CountingTransformer;
...
public class App {
  ...
  public static void main(String[] args) throws Exception {
    ...
    /*
      ...
      GigaStoreBuilder storeSupplier = new GigaStoreBuilder();
    ...
    */
    ...
    builder.addStateStore(new GigaStoreBuilder());
    builder
        .stream("source-topic", Consumed.with(Serdes.String(), Serdes.String()))
        .transform(CountingTransformer::new, GigaStateStore.STORE_NAME)
        .to("target-topic");
